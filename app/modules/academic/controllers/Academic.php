            ...
            <div class="list-group list-group-flush shadow-sm border rounded">
                ...
                <?php foreach ($details as $d): ?>
                    ...
                    <button
                        ...
                        onclick="getInfo(this.dataset.id),
                     $('#teacher_id').val(this.dataset.id),
                     $('#searchTeacher').val(this.dataset.name),
                     $('#teacherSearch').hide()"

                        data-id="<?php echo $d->employee_id ?>"
                        data-name="<?php echo strtoupper($d->lastname . ', ' . $d->firstname) ?>">

                        <div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center me-2"
                            style="width:32px;height:32px;font-size:14px;">

                            <?php echo strtoupper(substr($d->firstname, 0, 1)); ?>
                        ...
                        <div>
                            ...
                            <div class="fw-semibold">
                                <?php echo strtoupper($d->lastname . ', ' . $d->firstname) ?>
                            </div>

                            <small class="text-muted">
                                ID: <?php echo $d->employee_id ?>
                            </small>
            ...
            <?php
                                        ...
                                        function setAdviser()
                                        {
                                            ...
                                            if ($result):
                                                ...
                                                echo json_encode(array('status' => TRUE, 'msg' => 'Successfully Assigned'));
                                            else:
                                                echo json_encode(array('status' => FALSE, 'msg' => "Advisory Already Assigned"));
                                            endif;
                                        }
                                        ...
                                        function getSubjectPerSection()
                                        {
                                            $faculty_id = $this->input->post('faculty_id');
                                            $grade_id = $this->input->post('grade_id');
                                            $section_id = $this->input->post('section_id');
                                            $subj = $this->academic_model->getSubjectPerSection($faculty_id, $grade_id, $section_id);
                                            foreach ($subj as $s):
            ?>
            <option value="<?php echo $s->subj_id ?>"><?php echo $s->subject ?></option>
<?php
                                            endforeach;
                                        }
                                    }

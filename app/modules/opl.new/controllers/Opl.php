...
?>
    ...
    public function discussionBoard($school_year = NULL, $employee_id = NULL, $grade_level = NULL, $section = NULL, $subject = NULL)
    {
        ...
        $data = array(
            ...
            'subjectDetails' => $classDetails->subjectDetails,
            'headerTitle' => 'Discussion Board | ' . $classDetails->subjectDetails->subject . ' - ' . $classDetails->basicInfo->level . ' [ ' . $classDetails->basicInfo->section . ' ]',
            'main_header' => '',
            'login_page' => 'login/logout',
            'title' => 'Online Platform for Learning',
            'modules' => 'opl',
    ...
    public function newDiscussion($school_year = NULL)
    {
        ...
        $data = array(
            ...
            'getSubjects' => Modules::run('opl/opl_widgets/mySubject', $this->session->username, $school_year),
            'headerTitle' => 'Create A Discussion | ' . $classDetails->subjectDetails->subject . ' - ' . $classDetails->basicInfo->level . ' [ ' . $classDetails->basicInfo->section . ' ]',
            'main_header' => '',
            'title' => 'Online Platform for Learning',
            'login_page' => 'login/logout',
            'modules' => 'opl',
    ...
    public function createTask($school_year = NULL)
    {
        ...
        $data['getSubjects'] = Modules::run('opl/opl_widgets/mySubject', $this->session->username, $school_year);
        $data['school_year'] = $school_year;
        $data['headerTitle'] = 'New Task | ' . $classDetails->subjectDetails->subject . ' - ' . $classDetails->basicInfo->level . ' [ ' . $classDetails->basicInfo->section . ' ]';

...
function getImgLink($char, $pdf, $l, $t)
{
    switch ($char):
        case 'A':
            return $pdf->Image(SYMBOL_IMAGES . 'gs1.png', $l, $t, 5, '', 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);
        case 'B':
            return $pdf->Image(SYMBOL_IMAGES . 'gs2.png', $l, $t, 5, '', 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);
        case 'C':
            return $pdf->Image(SYMBOL_IMAGES . 'gs3.png', $l, $t, 5, '', 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);
        case 'D':
            return $pdf->Image(SYMBOL_IMAGES . 'gs4.png', $l, $t, 5, '', 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);
        default:
            return '';
    endswitch;
}
...
foreach ($subj_details as $sd):
    if ($sd->dpt_id != 2):
        ...
        getImgLink($rate1->rate, $pdf, $left, $top);
        getImgLink($rate2->rate, $pdf, ($left + 15), $top);
        getImgLink($rate3->rate, $pdf, ($left + 30), $top);
        getImgLink($rate4->rate, $pdf, ($left + 45), $top);
        $pdf->SetX(10);
        $pdf->SetFont('helvetica', 'R', 10);
...
$msg = Modules::run('customize/casaMsg', 1);
$pdf->SetFont('Times', 'I', 16);
$pdf->writeHTMLCell(112, '', '', $pdf->SetX(13), $msg, '', 1, 0, true, 'L', true);
$pdf->Ln(7);

$pdf->SetFont('Times', 'B', 16);
$pdf->SetX(65);
$pdf->MultiCell(60, 10, 'Dr. Maria Montessori', 0, 'L', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->Ln(10);

//========================================================= End Page 4 =========================================================//
//========================================================= Page 1 =============================================================//
$pls = SYMBOL_IMAGES . '/cardImages/pls.png';
$pdf->Image($pls, 158, 7, 100, '', 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);

$pdf->SetFont('Times', 'I', 10);
$pdf->SetXY(162, 20);
$pdf->MultiCell(90, 10, 'These exercises encourage independence and care of self which leads to good self-esteem, concentration and discipline.', 0, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->Ln(13);

$pdf->SetX(148);
$pdf->SetFont('pencilant', 'B', 15);
$pdf->MultiCell(60, 10, 'Life Skills', 'RTL', 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->SetFont('Roboto', 'I', 10);
$pdf->MultiCell(60, 5, 'GRADING PERIOD', 1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->Ln();
...
foreach ($subj_details as $sd):
    if ($sd->dpt_id != 2):
        ...
        $pdf->SetX(148);
        $pdf->SetFont('helvetica', 'R', 10);
        $pdf->MultiCell(60, 7, ($sd->psd_id == 23 || $sd->psd_id == 24 || $sd->psd_id == 25 ? '      ' . $sd->details : $sd->details), 'RBL', 'L', 0, 0, '', '', true, 0, false, true, 7, 'M');
        $pdf->MultiCell(15, 7, '', 1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
        $pdf->MultiCell(15, 7, '', 1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
        $pdf->MultiCell(15, 7, '', 1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
        $pdf->MultiCell(15, 7, '', 1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
...
$y = 0;
for ($x = 1; $x <= 6; $x++):
    $pdf->Image(SYMBOL_IMAGES . '/cardImages/pls' . $x . '.png', (148 + $y), 165, 20, '', 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);
    $y += 20;
endfor;
$pdf->Ln(25);
...
$pdf->SetX(150);
$pdf->MultiCell(109, 10, '“The environment must be rich in motives which lend interest to activity and invite the child to conduct his own experiences.”', 0, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->Ln();

$pdf->SetX(215);
$pdf->SetFont('helvetica', 'R', 10);
$pdf->MultiCell(45, 7, 'DR. MARIA MONTESSORI', 0, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
...
$pdf->Image($sme, 10, 10, 120, '', 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);
...
$y = 0;
for ($x = 1; $x <= 4; $x++):
    $pdf->Image(SYMBOL_IMAGES . '/cardImages/sme' . $x . '.png', (13 + $y), 80, 20, '', 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);
    $y += 30;
endfor;
$pdf->Ln(25);
...
$pdf->Image($l1, 10, 100, 30, '', 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);
$pdf->Image($lang, 40, 100, 50, '', 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);
...
$pdf->SetX(10);
$pdf->SetFont('pencilant', 'B', 12);
$pdf->MultiCell(60, 10, 'Language Activities', 'RTL', 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->SetFont('Roboto', 'I', 10);
$pdf->MultiCell(60, 5, 'GRADING PERIOD', 1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->Ln();
...
$pdf->SetX(148);
$pdf->SetFont('pencilant', 'B', 12);
$pdf->MultiCell(60, 10, 'Mathematical Activities', 'RTL', 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->SetFont('Roboto', 'I', 10);
$pdf->MultiCell(60, 5, 'GRADING PERIOD', 1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->Ln();
...
$pdf->Image($sci1, 148, 99, 30, '', 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);
$pdf->Image($sci, 180, 101, 35, '', 'PNG', '', '', false, 300, '', false, false, 0, false, false, false);

$pdf->SetFont('Times', 'I', 10);
$pdf->SetX(180);
$pdf->MultiCell(90, 10, 'These exercises facilitates recognition of scientific facts and realities and promotes critical thinking and observation among existing things.', 0, 'L', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->Ln(13);

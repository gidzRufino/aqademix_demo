...
class Opl_variables_model extends MX_Controller
{
    ...
    {
        $this->db = $this->eskwela->db($school_year);
        $this->db->select('lastname, firstname, sex, avatar, employee_id');
    ...
    {
        $this->db = $this->eskwela->db($school_year);
        $this->db->select('lastname, firstname, sex, avatar, profile_students.st_id, profile.user_id, grade_level_id, profile_students_admission.section_id, school_year, semester, str_id');

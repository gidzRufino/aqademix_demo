...
if ($discussionDetails->avatar != '' || $discussionDetails->avatar != NULL):
    if (file_exists('uploads/' . $discussionDetails->avatar)):
        $av = site_url('uploads/' . $discussionDetails->avatar);
    else:
        $av = site_url('images/avatar/' . ($discussionDetails->sex == 'Female' ? 'female.png' : 'male.png'));
    endif;
else:
    $av = site_url('images/avatar/' . ($discussionDetails->sex == 'Female' ? 'female.png' : 'male.png'));
endif;
    ...
    <div class="card card-blue card-outline">
        <div class="card-header">
            <div class="user-block">
                <img class="img-circle" width="50" src="<?php echo $av; ?>" alt="User Image">
            ...
            <?php if ($this->session->username == $discussionDetails->dis_author_id || $this->session->isOplAdmin): ?>
                <i class="fa fa-trash fa-xs float-right text-danger" style="cursor:pointer;" discussion-id="<?php echo $discussionDetails->dis_sys_code; ?>" discussion-title="<?php echo htmlspecialchars($discussionDetails->dis_title); ?>" onclick="readyDelete(this)"></i>
        ...
        <div class="card-footer">
            ...
            ?>
                <p><a href="<?php echo site_url('uploads/' . $school_year . DIRECTORY_SEPARATOR . 'faculty' . DIRECTORY_SEPARATOR . $discussionDetails->dis_author_id . DIRECTORY_SEPARATOR . $discussionDetails->dis_subject_id . DIRECTORY_SEPARATOR . 'discussion' . DIRECTORY_SEPARATOR . $discussionDetails->dis_attachments); ?>"><?php echo $discussionDetails->dis_attachments; ?></a></p>
            <?php
            endif;
            ?>
        </div>
...
<section id="commentDetails" class="col-lg-6 col-xs-12 float-left">
    <div class="card card-indigo card-outline">
        ...
        <div class="card-body">
            ...
            ?>
            <img class="img-fluid img-circle img-sm" width="50" src="<?php echo $av; ?>" alt="">

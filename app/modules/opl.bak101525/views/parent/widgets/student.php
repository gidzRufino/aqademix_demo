        ...
        <div class="list-group">
            ...
            foreach ($childLinks as $cl):
                if ($cl != ''):
                    ...
                    //print_r($student);
                    ?>
                    <a class="list-group-item list-group-item-action search-list" href="<?php echo base_url('opl/p/classBulletin/' . $student->grade_id . '/' . ($student->section_id != '' ? $student->section_id : 0) . '/' . $student->school_year); ?>">

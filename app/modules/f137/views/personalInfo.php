...
<div class="col-lg-12" id="searchStudent">
    ...
    <div class="input-group col-lg-8">
        ...
        <div class="input-group-btn">
            <button style="height: 46px; width: 150px;" type="button" class="btn btn-default dropdown-toggle" id="btnControl" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo (segment_5 == '' ? $this->session->school_year : segment_5) . ' - ' . ((segment_5 == '' ? $this->session->school_year : segment_5) + 1) ?> <span class="caret"></span></button>

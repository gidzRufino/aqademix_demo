...
<style scoped>
   body {
      background: linear-gradient(-45deg, #4a92f7, #84539b, #2d41b1, #ad0a32);
   ...
   .backimage {
      ...
      content: "";
      display: block;
      background-image: url('<?php echo base_url("assets/css/scanner_bg.jpg") ?>');
      /* Set the opacity to 25% */
      opacity: 0.25;
      /* Set the size and position of the background image */
      background-size: cover;
      background-position: center;
      /* Set the size of the pseudo-element to cover the entire .image-overlay div */
      width: 100%;
      height: 100%;
      /* Set the position property to enable z-index */
      position: absolute;
      top: 0;
      left: 0;
      /* Set a higher z-index value to position this pseudo-element above other elements */
      z-index: -1;
   }

   /* .backgroundimg{
            background: url('<?php echo base_url("assets/css/scanner_bg.jpg") ?>');
            opacity: 0.25;
            background-size: cover;
            background-position: center;
            height: 103%;
...
<body style="overflow-y: hidden;">
   ...
   <div style="margin:0; " class="contain" id="body-scan">
      <div class="backimage">
      ...
      <div class="clearfix row scan cont" style="margin: 0 auto 0">
         <input type="hidden" id="setAction" />
         <div class="col-md-4">
            <div class="row text-center">
               <img class="col-lg-12" id="avatar" style="margin-top:50px; margin-left: 30px; width:85%;" src="<?php echo base_url(); ?>images/forms/<?php echo $settings->set_logo ?>" />
            ...
            <div class="row-fluid" style="margin-top:30px;">
               <div id="shistory" class="span10">
                  ...
                  <div id="echo1" style="display:none;">
                     ...
                     <div class="row" style="padding: 10px; background: rgba(0, 0, 0, 0.1);">
                        <div class="col-md-8">
                           ...
                           <img id="img1" alt="" src="<?php echo base_url() ?>images/forms/<?php echo $settings->set_logo ?>" style="left: 5px; height:60px; border:solid white; position: relative;" class="img-square" />
                  ...
                  <div id="echo2" style="margin-top:20px; display:none;">
                     ...
                     <div class="row" style="padding: 10px; background: rgba(0, 0, 0, 0.1);">
                        <div class="col-md-8">
                           <img id="img2" alt="" src="<?php echo base_url() ?>images/forms/<?php echo $settings->set_logo ?>" style="left: 5px; height:60px; border:solid white; position: relative;" class="img-square" />
                  ...
                  <div id="echo3" style="margin-top:20px; display:none;">
                     ...
                     <div class="row" style="padding: 10px; background: rgba(0, 0, 0, 0.1);">
                        <div class="col-md-8">
                           <img id="img3" alt="" src="<?php echo base_url() ?>images/forms/<?php echo $settings->set_logo ?>" style="left: 5px; height:60px; border:solid white; position: relative;" class="img-square" />
      ...
      <div class="col-md-6" id="smsSend" hidden>
         ...
         <div class="modal-dialog" style="width:90%;">
            <div class="modal-content">
               <div class="adcontainer">
                  ...
                  <img class="ad-img" id="ad1" src="" style="height: 100%;">
      ...
      <div class='marquee' id="marquee" style="padding: 20px;">
   ...
   <script type="text/javascript">
      $(document).ready(function() {
         ...
         //    var url = '<?php // echo base_url() . 'messaging/toSendList' 
                           ?>';
         ...
         //             // sendMsg(data[x].sms_user_id, data[x].sms_cat, data[x].sms_id, data[x].sms_number, data[x].sms_message);
         //          }
         //       }
         //    });
         // }, 20000);
      ...
      // function sendMsg(smsUID, smsCat, smsID, number, msg) {
            ...
            $.ajax({
               ...
               success: function(data) {
                  if (data.status) {
                     ...
                     reset_ad_timer();
                     // $("#shistory").fadeOut(25000);
                     // $("#sstatus").fadeOut(15000);
                  } else {
      ...
      function pageRefresh() {
         ...
         $("#avatar").attr("src", "<?php echo base_url(); ?>images/forms/<?php echo $settings->set_logo ?>");
         $("#shistory").hide();
         $("#sstatus").hide();
      }

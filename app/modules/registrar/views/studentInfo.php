    ...
    <div class="well col-lg-12" id="profBody">
        <div class="col-lg-2">
            ...
            <div id="imgCrop" data-id="photo">
                <?php if ($students->avatar != ''):
                    if (file_exists('uploads/' . $students->avatar)):
                ?>
                        <img class="img-circle" style="width:150px; border:5px solid #fff" src="<?php echo base_url() . 'uploads/' . $students->avatar  ?>" />
                    <?php else: ?>
                        <img class="img-circle" style="width:150px; border:5px solid #fff" src="<?php echo base_url() . 'images/avatar/' . ($students->sex == 'Female' ? 'female.png' : 'male.png')  ?>" />
                    <?php endif; ?>
                <?php else: ?>
                    <img class="img-circle" style="width:150px; border:5px solid #fff" src="<?php echo base_url() . 'images/avatar/' . ($students->sex == 'Female' ? 'female.png' : 'male.png')  ?>" />
                <?php endif; ?>
                <!-- <img class="img-circle img-responsive" style="width:150px; border:5px solid #fff" src="<?php
                                                                                                            ...
                                                                                                            //else: echo base_url(). 'images/avatar/' . ($student->sex === 'Female' ? 'female.png' : 'male.png');
                                                                                                            // endif;
                                                                                                            ?>" /> -->
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <!--do not delete commented button-->
            ...
            <button class="btn-success btn-xs pull-right" st-iw="<?php echo base64_encode($students->st_id); ?>" onclick="readyPrint_updated(this)">Print Admission</button>
            <!-- <input type="button" value="Summerhill"  onclick="window.open('<?php echo site_url('registrar/printAdmission_updated'); ?>')" /> -->
            <script>
                ...
                function readyPrint_updated(btn) {
                    var st_id = $(btn).attr('st-iw'),
                        url = "<?php echo site_url('registrar/printAdmission_updated'); ?>/" + st_id;
                    window.open(url);
                }
            </script>
        </div>
        <?php
        if ($this->session->userdata('position_id') == 1 || $this->session->userdata('position_id') == 49 || $this->session->userdata('position_id') == 69):
            if (!$userPass):
        ?>
                <div class="col-lg-4">
                    <br>
            ...
            <?php else: ?>
                <div class="col-lg-2" style="float: right; color: gray; padding-left: 55px">
                    <br>
                    <label>Student's Password:</label><br>
        ...
        <div style="padding-top: 15px;" class="tab-pane active" id="PersonalInfo">
            ...
            <dl class="dl-horizontal">
                ...
                <dd>
                    ...
                    <?php endif; ?>
                    <i id="saveContactBtn" onclick="saveMobile('<?php echo $user_id ?>', $('#mobile').val(), 'cd_mobile', 'a_mobile'), $('#a_mobile').show(), $('#mobile').hide(), $('#editContactBtn').show(), $('#saveContactBtn').hide(), $('#closeContactBtn').hide()" style="font-size:15px; display: none; " class="fa fa-save clickover pointer"></i>
            ...
            <dl class="dl-horizontal">
                ...
                <dd>
                    <span title="double click to edit" id="a_email">
                        <?php
                        if ($students->cd_email != ""): echo $students->cd_email;
                        else: echo "[empty]";
                        endif;
                        ?>

                    </span>
                    <input style="display: none; width:300px" type="text" id="email" value="<?php echo $students->cd_email; ?>" />
                    ...
                    <i id="saveEmailBtn" onclick="saveMobile('<?php echo $user_id ?>', $('#email').val(), 'cd_email', 'a_email'), $('#a_email').show(), $('#email').hide(), $('#editEmailBtn').show(), $('#saveEmailBtn').hide(), $('#closeEmailBtn').hide()" style="font-size:15px; display: none; " class="fa fa-save clickover pointer"></i>
                ...
                <dd style="color:black; ">
                    ...
                    <?php if ($this->session->position_id != 39 || $isAdv): ?>
                        <i style="font-size:15px; color:#777;" class="fa fa-pencil-square-o clickover pointer <?php echo $editable ?>"
                            rel="clickover"
                            <?php if ($this->session->userdata('is_admin') || $this->session->position == 'Faculty'): ?>
                            data-content=" 
            ...
            <div class="col-lg-6" style="padding-left: 0;">
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <span id="F_educAttainValue"><?php echo strtoupper($f_educ->attainment); ?></span>
                        <small>
                            <?php if ($this->session->position_id != 39 || $isAdv): ?>
                                <i style="font-size:15px; color:#777;" class="fa fa-pencil-square-o clickover pointer <?php echo $editable ?> <?php echo $editable ?>"
                                    rel="clickover"
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        ...
                        <span id="a_f_occupation"><?php echo ($f_occ != NULL ? strtoupper($f_occ->occupation) : ''); ?></span>
                        <input style="display: none; width:300px" type="text" id="f_occupation" value="<?php echo ($f_occ != NULL ? $f_occ->occupation : ''); ?>"
                            onkeypress=""
                            title="press enter to save your edit" />
                        <?php if ($this->session->position_id != 39 || $isAdv): ?>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        ...
                        <?php if ($this->session->position_id != 39 || $isAdv): ?>
                            ...
                            <i id="saveFMobileBtn" onclick="updateProfile('<?php echo base64_encode('p_id') ?>', '<?php echo base64_encode('esk_profile_parent') ?>', '<?php echo $students->p_id ?>', 'f_mobile', $('#fmobile').val(), 'fmobile'), $('#a_fmobile').show(), $('#fmobile').hide(), $('#editFMobileBtn').show(), $('#saveFMobileBtn').hide(), $('#closeFMobileBtn').hide()" style="font-size:15px; display: none; " class="fa fa-save clickover pointer"></i>
            ...
            <div class="col-lg-6">
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <span id="M_educAttainValue"><?php echo ($m_educ != NULL ? strtoupper($m_educ->attainment) : ''); ?></span>
                        <small>
                            <?php if ($this->session->position_id != 39 || $isAdv): ?>
                                <i style="font-size:15px; color:#777;" class="fa fa-pencil-square-o clickover pointer <?php echo $editable ?>"
                                    rel="clickover"
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        ...
                        <span id="a_m_occupation"><?php echo ($m_occ != null ? strtoupper($m_occ->occupation) : ''); ?></span>
                        <input style="display: none; width:250px" type="text" id="m_occupation" value="<?php echo ($m_occ != null ? $m_occ->occupation : ''); ?>"
                            onkeypress="if (event.keyCode == 13) {
            ...
            <?php if (strtolower($settings->short_name) == 'summerhill') { ?>
                <hr style="margin:3px 0;" />
                <h5>Last School Attended:</h5><br>
                <dl class="dl-horizontal">
                    <dt>
                        School Last Attended:
                    </dt>
                    <dd>
                        <span title="double click to edit" id="a_lsa_name"><?php
                                                                            if ($students->school_last_attend != ""): echo strtoupper($students->school_last_attend);
                                                                            else: echo "[empty]";
                                                                            endif;
                                                                            ?></span>
                        <input style="display: none; width:300px" type="text" id='lsa_name' value="<?php echo $students->school_last_attend; ?>" />
                        <?php if ($this->session->position_id != 39 || $isAdv): ?>
                            <i id="editLsa_nameBtn" onclick="$('#a_lsa_name').hide(), $('#lsa_name').show(), $('#lsa_name').focus(), $('#closeLsa_nameBtn').show(), $('#saveLsa_nameBtn').show(), $(this).hide()" style="font-size:15px; color:#777;" class="fa fa-pencil-square-o clickover pointer <?php echo $editable ?>"></i>
                            <i id="saveLsa_nameBtn" onclick="updateProfile('<?php echo base64_encode('user_id') ?>', '<?php echo base64_encode('esk_profile_students_admission') ?>', <?php echo ($students->u_id) ?>, 'school_last_attend', $('#lsa_name').val(), 'lsa_name'),$('#a_lsa_name').show(), $('#lsa_name').hide(), $('#editLsa_nameBtn').show(), $('#saveLsa_nameBtn').hide(), $('#closeLsa_nameBtn').hide()" style="font-size:15px; display: none; " class="fa fa-save clickover pointer"></i>
                            <!--<i id="saveLsa_nameBtn"  onclick="document.write('hello');" style="font-size:15px; display: none; " class="fa fa-save clickover pointer"></i>-->
                            <i id="closeLsa_nameBtn" onclick=" $('#a_lsa_name').show(), $('#lsa_name').hide(), $('#editLsa_nameBtn').show(), $('#saveLsa_nameBtn').hide(), $(this).hide()" style="font-size:15px; display: none; " class="fa fa-close clickover pointer text-danger"></i>
                        <?php endif; ?>
                    </dd>
                    <br>
                    <dt>
                    ...
                    <dd>
                        <span title="double click to edit" id="a_lsa_addname"><?php
                                                                                if ($students->school_last_attend != ""): echo strtoupper($students->sla_address);
                                                                                else: echo "[empty]";
                                                                                endif;
                                                                                ?></span>
                        <input style="display: none; width:300px" type="text" id='lsa_addname' value="<?php echo $students->sla_address; ?>" />
                        <?php if ($this->session->position_id != 39 || $isAdv): ?>
                            <i id="editLsa_addnameBtn" onclick="$('#a_lsa_addname').hide(), $('#lsa_addname').show(), $('#lsa_addname').focus(), $('#closeLsa_addnameBtn').show(), $('#saveLsa_addnameBtn').show(), $(this).hide()" style="font-size:15px; color:#777;" class="fa fa-pencil-square-o clickover pointer <?php echo $editable ?>"></i>
                            <i id="saveLsa_addnameBtn" onclick="updateProfile('<?php echo base64_encode('user_id') ?>', '<?php echo base64_encode('esk_profile_students_admission') ?>', <?php echo ($students->u_id) ?>, 'sla_address', $('#lsa_addname').val(), 'lsa_addname'),$('#a_lsa_addname').show(), $('#lsa_addname').hide(), $('#editLsa_addnameBtn').show(), $('#saveLsa_addnameBtn').hide(), $('#closeLsa_addnameBtn').hide()" style="font-size:15px; display: none; " class="fa fa-save clickover pointer"></i>
                            <!--<i id="saveLsa_addnameBtn" onclick="document.write('<?php echo $students->u_id . ' ' . $students->p_id ?>'),$('#a_lsa_addname').show(), $('#lsa_addname').hide(), $('#editLsa_addnameBtn').show(), $('#saveLsa_addnameBtn').hide(), $('#closeLsa_addnameBtn').hide()" style="font-size:15px; display: none; " class="fa fa-save clickover pointer"></i>-->
                            <!--<i id="saveLsa_nameBtn"  onclick="document.write('<?php echo $students->u_id . ' ' . $students->p_id ?>');" style="font-size:15px; display: none; " class="fa fa-save clickover pointer"></i> -->
                            <i id="closeLsa_addnameBtn" onclick=" $('#a_lsa_addname').show(), $('#lsa_addname').hide(), $('#editLsa_addnameBtn').show(), $('#saveLsa_addnameBtn').hide(), $(this).hide()" style="font-size:15px; display: none; " class="fa fa-close clickover pointer text-danger"></i>
                        <?php endif; ?>
                    </dd>
                </dl>
            <?php } ?>
            ...
            <div class="col-lg-6">
                ...
                <div class="col-lg-12" style="padding-left: 0;">
                    <dl class="dl-horizontal">
                        ...
                        <dd>
                            <span title="double click to edit" id="a_ice_name">
                                <?php
                ...
                <div class="col-lg-12">
                    <dl class="dl-horizontal">
                        ...
                        <dd>
                            <span title="double click to edit" id="a_ice_contact">
                                <?php
                ...
                <div class="col-lg-12" style="padding-left: 0;">
                    ...
                    ?>
                        <div class="col-lg-6">
                            ...
                            <dl class="dl-horizontal">
                                <dt>Username:</dt>
                                <dd><?php echo $students->uname ?></dd>
                                <dt>Password:</dt>
                                <dd><?php echo ($students->is_agp ? $students->secret_key : '**********') ?></dd>
                            </dl>
                            <button class="btn-primary" onclick="requestOTP('<?php echo $students->ice_contact ?>')">Reset Password</button>
                        </div>
                        <div class="col-lg-6">
                            Sibling/s in School:
                            <dl class="dl-horizontal pointer">
                                <?php
                                ...
                                ?>
                                        <dt onclick="window.location.href = '<?php echo base_url() . 'registrar/viewDetails/' . base64_encode($ss->st_id); ?>'"><?php echo $s; ?></dt>
                                        <dd><?php echo ucwords(strtolower($ss->firstname . " " . $ss->lastname)) ?></dd>
                                <?php
                                    endif;
                                endforeach;
                                ?>
                    ...
                    <?php
                        ...
                        <button class="btn-success btn-md" onclick="generateAcc('<?php echo $students->ice_name ?>', '<?php echo $students->ice_contact ?>', '<?php echo $students->p_id ?>')">Gemerate Parent's Account</button>
                    <?php
                    endif;
                    ?>
                </div>
...
<script type="text/javascript">
    ...
    function saveMobile(user_id, mobile_no, column, span) {

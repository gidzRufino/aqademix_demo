                ...
                <div class="form-group pull-right">
                 ...
                 <div class="form-group pull-right">
                    <select style="width:200px; font-size: 15px;" id="sem" onchange="getStudentByTerm(this.value)" tabindex="-1" class="populate select2-offscreen span2">
                        <option <?php echo ($this->uri->segment(4) == 0 || '' ? 'selected' : '' ) ?> value="0">Regular Class</option>
                        <option <?php echo ($this->uri->segment(4) == 3 ? 'selected' : '' ) ?> value="3">Summer Class</option>
                    </select>
                 </div>
            <?php } ?>
        </h3>
                    ...
                    <?php 
                        ...
                        //     if($section->num_rows() > 0):
                                ...
                                <tr id="tr_<?php //echo $level->grade_id ?>">
                                    ...
                                    ?>
                                            <td id="td_<?php// echo $s->section_id ?>" style="background:#C1FFF9; border:1px solid gray;" onclick="setRO('<?php echo $level->grade_id ?>','<?php echo $s->s_id ?>'), $('#ro_strand_id').val('<?php echo $s->str_id ?>')" class="pointer text-center"><?php echo $s->section ?> <span id="badge_<?php echo $s->s_id ?>" class="badge text-danger"><?php echo $studentsPerSection ?></span></td>
                                        <?php
                                        //endforeach;
                                        ?>
                                </tr>
                            <?php //else: ?>
                                <tr id="tr_<?php// echo $level->grade_id ?>">
                                    <td id="td_<?php// echo $level->grade_id ?>" style="background:#C1FFF9; border:1px solid gray;" onclick="setRO('<?php echo $level->grade_id ?>', 0)" class="pointer text-center"><?php echo $level->level ?></td>
                                </tr>
                            <?php //endif; ?>                    
                    <?php
                   // }

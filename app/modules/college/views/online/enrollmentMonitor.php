                ...
                <?php if ($school_year != NULL && $semester != NULL): ?>
                    ...
                    <div class="clearfix row">
                        <div class="col-lg-8 col-xs-12">
                            ...
                            <?php
                            if ($this->eskwela->getSet()->short_name != 'aac'): ?>
                                <div class="col-lg-12">
                                    <div class="panel panel-success">
                                        <div class="panel-heading">
                                            Padala Centers
...
<script type="text/javascript">
    ...
    function getEnrollmentDetails(status, semester, school_year, title) {
        var base = $('#base').val();
        var url = base + 'college/enrollment/listOfStudentsEnrolled/' + semester + '/' + school_year + '/' + status + '/null';
    ...
    function addPadala(btn) {
        var form = $(btn).parent().prev().find("#addPadalaForm"),
            ...
            formData = new FormData(form[0]);
        formData.append('pcLogo', form.find("#pcLogo")[0].files[0]);
        formData.append('sy', <?php echo segment_5 ?>);
        formData.append('csrf_test_name', $.cookie('csrf_cookie_name'));
        if (type != -1) {
            $.ajax({

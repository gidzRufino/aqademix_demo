...
foreach ($course as $c):
    ...
    if ($c->course != ""):
        if ($c->dept_id < 4):
            ...
            $pdf->MultiCell(250, 5, $c->course, 'TB', 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');
            ...
            $pdf->Ln();
            $x++;
            $students = Modules::run('college/getStudentPerCourse', $c->course_id, segment_4, segment_5, NULL, NULL, NULL, 1);
            ...
            foreach ($students->result() as $st):
                ...
                if ($st->status):
                    ...
                    $pdf->MultiCell(60, 5, ($y == 1 ? strtoupper($st->lastname) . ', ' . ucwords(strtolower($st->firstname)) . ' ' . ucwords(strtolower($middlename)) : ""), 1, 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');

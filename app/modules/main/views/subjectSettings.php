<div class="row">
    ...
    <div class="col-lg-12">
        <ul class="nav nav-tabs" role="tablist" id="dcms_tab">
            ...
            ?>
                <li class="<?php echo $hide ?> <?php echo $active; ?>"><a href="#<?php echo $dept->level_dept_id ?>"><?php echo $dept->level_department ?> ss</a></li>
            <?php
            endforeach;
            ?>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body" onmouseover="$('#grade_id').val('<?php echo $list->grade_id; ?>'),$('#subjects').val('<?php echo $subjects->subject_id; ?>')">
                                        <ul id="<?php echo $list->grade_id ?>_section" style="list-style: disc">
                                            ...
                                            ?>
                                                <li id="<?php echo $s->id; ?>_sub" onmouseover="$('#sub_id').val('<?php echo $s->id; ?>'), $('#subjects').val('<?php echo $s->sub_id; ?>')"><?php echo $singleSub->subject ?></li>
                                            <?php }
                                            ?>
                                        </ul>
                                    </div>
...
<div id="otherMenu">
    <ul class="dropdown-menu" role="menu">
        ...
        <li class="pointer"><a onclick="$('#editSubject').modal('show')" tabindex="-1"><i class="fa fa-edit fa-fw"></i>Edit Subject</a></li>
        <li class="divider"></li>

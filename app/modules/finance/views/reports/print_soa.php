...
foreach ($studperlevel as $spl) {
    ...
    //     $pdf->MultiCell(40, 0, $ol[1], 'LBT', 'L', 0, 0, '', '', true, 0, false, true, 0, 'M');
    //     $pdf->Ln();
    // endforeach;
    else:
    ...
    if ($transaction->num_rows() > 0):
        ...
        foreach ($transaction->result() as $tr):
            ...
            //     if ($ol[0] == $tr->item_id):
            //         array_push($othersPaid, [$tr->item_id, $tr->t_amount, $tr->item_description]);
            //     endif;
            // endforeach;
    ...
    // $tuitionMonthBal = $monthTuitionToPay - $totalTuition; 
    // $tuitionArr = $tuitionMonthBal - $monthlyTuition;
    else:
        $tuitionMonthBal = 0;
        $tuitionArr = 0;
    endif;
    ...
    // $pdf->MultiCell(20, 0, number_format($min_amount_due, 2, '.', ','), 'RBT', 'R', 0, 0, '', '', true, 0, false, true, 0, 'M');

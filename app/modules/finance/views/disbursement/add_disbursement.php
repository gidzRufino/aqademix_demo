      ...
      <div class="modal-body">
         ...
         <div class="row">
           <div class="col-md-12">
              ...
              <div id="is_clear" class="form-group has-feedback">
                 <label id="checklabel">Clearance Date</label>
                 <input type="text" class="form-control datepicker" id="db_clearance_date" placeholder="Cheque Clearance Date">
              </div>
            </div>
         </div>
      </div>
...
<script type="text/javascript">
   $("#send_disbursement").click(function(){
      ...
      var cleared = $("#db_clearance_date").val();
      var url = "<?php echo base_url().'finance/add_disbursement' ?>";
      $.ajax({
         type: "POST",
         url: url,
         dataType: 'json',
         data: "&cleared="+cleared+"&category="+category+"&vendor="+vendor+"&amount="+amount+"&type="+type+"&bank="+bank+"&check="+check+"&name="+name+'&csrf_test_name='+$.cookie('csrf_cookie_name'),

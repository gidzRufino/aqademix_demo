         ...
         <div class="row">
           <div class="col-md-12">
              ...
              <div id="is_clear" class="form-group has-feedback">
                 ...
                 <input type="text" class="form-control datepicker" id="up_clear_date" placeholder="Clearance Date">
              </div>
            </div>
         </div>
      </div>
...
<script type="text/javascript">
   $('#up_paytype').on('change', function() {
      ...
      switch (selectedValue) {
         case '1':
            ...
            $("#up_bank, #is_cheque, #up_clear_date").hide();
            $("#up_cheque").show();
            break;
         case '2':
            $("#upchecklabel").text('Cheque Number');
            $("#up_bank, #up_cheque, #is_cheque, #up_clear_date").show();
            break;
         case '3':
            $("#upchecklabel").text('Reference Number');
            $("#is_cheque, #up_clear_date").hide();
   ...
   $("#update_disbursement").click(function () {
       ...
       const clearance = $("#up_clear_date").val();

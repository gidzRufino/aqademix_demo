            ...
            <div class="row-fluid" style="margin-top:30px;">
               <div id="shistory" class="span10">
                  ...
                  <div id="echo1" style="display:none;">
                     ...
                     <div class="row" style="padding: 10px; background: rgba(0, 0, 0, 0.1);">
                        <div class="col-md-8">
                           ...
                           <img id="img1" alt="" src="<?php echo base_url()?>images/avatar/noImage.png" style="left: 5px; height:60px; border:solid white; position: relative;"  class="img-square"/>
                  ...
                  <div id="echo2" style="margin-top:20px; display:none;">
                     ...
                     <div class="row" style="padding: 10px; background: rgba(0, 0, 0, 0.1);">
                        <div class="col-md-8">
                           <img id="img2" alt="" src="<?php echo base_url()?>images/avatar/noImage.png" style="left: 5px; height:60px; border:solid white; position: relative;"  class="img-square"/>
                  ...
                  <div id="echo3" style="margin-top:20px; display:none;">
                     ...
                     <div class="row" style="padding: 10px; background: rgba(0, 0, 0, 0.1);">
                        <div class="col-md-8">
                           <img id="img3" alt="" src="<?php echo base_url()?>images/avatar/noImage.png" style="left: 5px; height:60px; border:solid white; position: relative;"  class="img-square"/>
         ...
         $.ajax({
            ...
            success: function(data)
            {
               if(data.status){
                  ...
                  reset_ad_timer();
                  $("#shistory").fadeOut(25000); $("#sstatus").fadeOut(15000);
               }else{

        ...
        <div class="col-lg-12" style="margin: 10px;">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    <?php
                    $directory = 'uploads/' . DIRECTORY_SEPARATOR . $student->school_year . DIRECTORY_SEPARATOR . 'students' . DIRECTORY_SEPARATOR . $student->st_id . DIRECTORY_SEPARATOR . 'files';
                    // echo $directory;
                            ...
                            if ($paymentReceipt->row() || $payment > 0):
                                ...
                                <tr>
                                    <td colspan="2" class="text-center">
                                        ...
                                        <?php
                                        $directory = 'uploads/' . DIRECTORY_SEPARATOR . $student->school_year . DIRECTORY_SEPARATOR . 'students' . DIRECTORY_SEPARATOR . $student->st_id . DIRECTORY_SEPARATOR . 'online_payments';
                                        // echo $directory;
                                        $scanFiles = scandir($directory);
                                        $files = array_diff($scanFiles, array('..', '.'));
                                        foreach ($files as $file):

...
<div >
    <div style="position:absolute; top:65px; width:950px;">
        ...
        <div style="position: absolute; top:127px; left:50px;">
            <table>
                <tr>
                    <td style="text-align: left;font-size: 17px;"><?php echo $student->fo_account_id; ?></td>
                </tr>
            </table>
        </div>
        <div style="position: absolute; top:127px; left:280px;">
            <table>
                <tr>
                    <td style="text-align: left;font-size: 17px;"><?php echo strtoupper($student->fo_lastname.', '.$student->fo_firstname); ?></td>
                </tr>
            </table>
        </div>
        <?php

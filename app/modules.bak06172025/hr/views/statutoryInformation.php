<dl class="dl-horizontal">
    ...
    <dd>
        <span title="double click to edit" id="a_salary">
            <?php
            //print_r($basicInfo);
            if ($basicInfo->salary != ""): echo $basicInfo->salary;
            else: echo "[empty]";
            endif; ?>
        </span>
...
<dl class="dl-horizontal">
    ...
    <dd>
        <span title="double click to edit" id="a_sg">
            <?php if ($basicInfo->pst_id != ""): echo $basicInfo->pst_type;
            else: echo "[empty]";
            endif; ?>
        </span>
        <?php if ($this->session->userdata('is_admin')): ?>
...
<dl class="dl-horizontal">
    ...
    <dd>
        <span title="double click to edit" id="a_credits">
            <?php
            //print_r($basicInfo);
            if ($basicInfo->leave_credits != 0.0): echo $basicInfo->leave_credits;
            else: echo "[empty]";
            endif; ?>
        </span>
        <?php if ($this->session->userdata('is_admin')): ?>
...
<dl class="dl-horizontal">
    ...
    <dd>
        <span title="double click to edit" id="a_sss">
            <?php if ($basicInfo->sss != ""): echo $basicInfo->sss;
            else: echo "[empty]";
            endif; ?>
        </span>
...
<dl class="dl-horizontal">
    ...
    <dd>
        <span title="double click to edit" id="a_philhealth">
            <?php if ($basicInfo->phil_health != ""): echo $basicInfo->phil_health;
            else: echo "[empty]";
            endif; ?>
...
<dl class="dl-horizontal">
    ...
    <dd>
        <span title="double click to edit" id="a_pag_ibig">
            <?php if ($basicInfo->pag_ibig != ""): echo $basicInfo->pag_ibig;
            else: echo "[empty]";
            endif; ?>
        </span>
...
<dl class="dl-horizontal">
    ...
    <dd>
        <span title="double click to edit" id="a_tin">
            <?php if ($basicInfo->tin != ""): echo $basicInfo->tin;
            else: echo "[empty]";
            endif; ?>
        </span>

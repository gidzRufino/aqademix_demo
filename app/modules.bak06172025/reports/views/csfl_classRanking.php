...
class MYPDF extends Pdf {
    ...
    public function Header() {
        ...
        $this->Cell(0, 0, 'S.Y. ' . segment_6 . ' - ' . $nextYear, 0, false, 'C', 0, '', 0, false, 'M', 'T');
        $this->Ln();
...
$section = Modules::run('registrar/getSectionById', segment_3);
$adviser = Modules::run('academic/getAdvisory', '', segment_6, segment_3);
...
$student = Modules::run('gradingsystem/gradingsystem_reports/generateTop', segment_3, segment_5, $students);
...
$pdf->MultiCell(75, 10,  strtoupper($adviser->row()->firstname.' '.$adviser->row()->lastname) . ', LPT',0, 'C', 0, 0, '', '', true, 0, false, true, 10, 'B');
$pdf->Ln();
...
$pdf->SetX(5);
$pdf->MultiCell(25, 10, '', 0, 'C', 0, 0, '', '', true, 0, false, true, 10, 'B');
$pdf->MultiCell(75, 10, 'ABIGAIL GRACE O. LAPUT, LPT', 0, 'C', 0, 0, '', '', true, 0, false, true, 10, 'B');
$pdf->MultiCell(25, 10, '', '', 'R', 0, 0, '', '', true, 0, false, true, 10, 'B');
$pdf->MultiCell(75, 10, 'LUCY P. BAGONGON, M.A', 0, 'C', 0, 0, '', '', true, 0, false, true, 10, 'B');
$pdf->Ln();

...
class customize extends MX_Controller
{
    ...
    public function printReportCard($short_name, $student, $admitted, $school_year, $grading)
    {
        ...
        $data['sy'] = $school_year;
        if ($student->deptCode == 11):
            switch ($student->grade_id):
                case 16:
                case 14:
                case 17:
                    $this->load->view($short_name . '/reportCard_casa', $data);
                    break;
                case 1:
                case 15:
                    $this->load->view($short_name . '/reportCard_casaJS', $data);
                    break;
            endswitch;
        else:
    ...
    public function generateReportCard($short_name, $student, $term, $behavior, $core, $school_year)
    {
        ...
        if ($student->deptCode != 11):
            ...
            $this->load->view($short_name . '/generateReportCard_ps', $data);
        endif;
    }
...
?>
    ...
    function msgToParents()
    {
    ?>
        Dear Parent,
        <p style="text-indent: 50px; word-spacing: 5px">
    ...
    ?>
        <p style="text-align: center;">
            Your signature signifies that you have thoroughly read the details of the progress of your child both in academic and character building for the particular quarter. Thank you.
        </p>
<?php
    }

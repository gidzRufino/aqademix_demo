...
class calendar extends MX_Controller {
    ...
    function getSpecificDateEvent($date) {
        return $this->calendar_model->getSpecificDateEvent($date);
    }
    
    function isHoliday($date){
        return $this->calendar_model->isHoliday($date);
    }
    ...
    public function editBdate()
    {
        ...
        $this->calendar_model->saveBDate($array,$owner,$sy, $table);

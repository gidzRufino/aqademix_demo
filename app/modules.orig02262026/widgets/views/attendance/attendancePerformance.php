<div id="attPerformance" >  
    <div class="col-12 pointer" onclick="//getAttendanceProgress('<?php echo $level->row()->section_id ?>','<?php echo $level->row()->level ?>', '<?php echo $level->row()->section ?>')"  >
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-7 text-right" style="border-left: 1px solid white;">
                        ...
                        <hr />
                        <?php $presents = $numberOfPresents->num_rows(); ?>
                        <div class="huge"><?php echo $presents == 0 || $numberOfSchoolDays == 0 ? 0 : round($presents/($numberOfSchoolDays)); ?></div>

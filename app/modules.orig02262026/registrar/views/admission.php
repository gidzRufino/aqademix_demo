...
<div class="row">
    <div class="col-lg-12">
        <div class="col-lg-12 col-xs-12">
            ...
            endswitch;
            ?>
            <h3 style="margin-top: 20px;" class="page-header"><?php echo $header     ?>
                <br />
...
<div class="formHeader row">
    ...
    <div class="col-lg-3 col-xs-12 pull-right">
        ...
        <button onclick="document.location = '<?php echo base_url('main/dashboard') ?>'" class="btn btn-danger btn-sm col-lg-2 col-xs-12 btn-block">CANCEL</button>
    </div>
</div>
...
<div class="modal" id="loginInfo">
    <div class="panel panel-info" style="width: 50%; margin-left: 25%; margin-top: 5%;">
        ...
        <div class="panel-footer">
            ...
            <button class="btn btn-success" onclick="document.location.href = '<?php echo base_url() . 'main/dashboard' ?>'">Dashboard</button>
        </div>
    </div>
</div>

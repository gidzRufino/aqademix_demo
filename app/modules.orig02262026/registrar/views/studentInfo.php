...
<div class="row">
    <ul class="nav nav-tabs" role="tablist" id="profile_tab">
        ...
        <li><a href="#attendanceInformation" data-toggle="tab">Attendance Information</a></li>
        <li><a href="#academicInformation" data-toggle="tab">Academic Information</a></li>
        <li><a href="#medicalInformation" data-toggle="tab">Medical Information</a></li>
        <?php if ($this->session->position_id != 39): ?>
            <li><a href="#enrollmentRequirements" data-toggle="tab">Requirements for Enrollment</a></li>
        <?php endif; ?>
        <li><a href="#personalFiles" data-toggle="tab">Personal Files</a></li>
    ...
    <div class="tab-content col-lg-12">
        <div style="padding-top: 15px;" class="tab-pane active" id="PersonalInfo">
            ...
            <div class="col-lg-6" style="padding-left: 0;">
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <span id="F_educAttainValue"><?php echo strtoupper($students->f_educ); ?></span>
                        <small>
                            <?php if ($this->session->position_id != 39 || $isAdv): ?>
                                <i style="font-size:15px; color:#777;" class="fa fa-pencil-square-o clickover pointer <?php echo $editable ?>"
                                    rel="clickover"
                    ...
                    ?>
                        <div class="col-lg-6">
                            ...
                            <dl class="dl-horizontal">
                                ...
                                <dt>Password:</dt>
                                <dd><?php echo ($students->autoGen ? $students->secret_key : '**********') ?></dd>
                            </dl>
        ...
        <div style="padding-top: 15px;" class="tab-pane" id="personalFiles">
            <div class="col-lg-6">
                <div class="row">

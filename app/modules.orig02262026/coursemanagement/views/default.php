                        ...
                        <ul id="k12" class="col-lg-4">
                            ...
                            ?>
                                ...
                                <ul id="<?php echo $list->grade_id ?>_section" style="list-style: disc">
                                    ...
                                    ?>
                                        <li id="<?php echo $s->s_id ?>_li" onmouseover="$('#sec_name').val('<?php echo $s->section ?>'), $('#sec_id').val('<?php echo $s->s_id ?>'), $('#grade_id').val('<?php echo $list->grade_id ?>')"><?php echo $s->section ?></li>
                                    <?php } ?>
                                </ul>
                            <?php
                            endforeach;
...
<script type="text/javascript">
    ...
    function editSection() {
        ...
        var sec = $('#eSec').val();
        var url = '<?php echo base_url() . 'coursemanagement/editSection/' ?>' + sec + '/' + secID;
        $.ajax({
            type: 'GET',
            url: url,
            data: '',

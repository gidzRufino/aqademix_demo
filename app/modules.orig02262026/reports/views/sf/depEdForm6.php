...
$CI = &get_instance();
		...
		$this->Cell(0, 15, '(This replaces Form 20)', 0, false, 'C', 0, '', 0, false, 'M', 'M');
                ...
                $this->SetXY(270,50);
                $this->Cell(0,4.3,"School Year : ".$CI->uri->segment(3).'-'.$nextYear, 0, false, 'L', 0, '', 0, false, 'M', 'M');
        }
...
$g7 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 2, $sy));
$g8 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 3, $sy));
$g9 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 4, $sy));
if($CI->uri->segment(3)==2014):
    $g10 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 18, $sy));    
else:    
    $g10 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 5, $sy));    
endif;

$g11 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 6, $sy));
$g12 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 7, $sy));

//Promoted starts
$pdf->SetX(8);
$pdf->MultiCell(40, 7, 'PROMOTED',1, 'L', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 1 / grade 7
$pdf->MultiCell(13, 7,($g7->pro_m != '' ? $g7->pro_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g7->pro_f != '' ? $g7->pro_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g7->pro_m+$g7->pro_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');


//grade 2 / grade 8
$pdf->MultiCell(13, 7, ($g8->pro_m != '' ? $g8->pro_m : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g8->pro_f != '' ? $g8->pro_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g8->pro_m+$g8->pro_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 3 / grade 9
$pdf->MultiCell(13, 7, ($g9->pro_m != '' ? $g9->pro_m : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g9->pro_f != '' ? $g9->pro_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g9->pro_m+$g9->pro_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 4 / grade 10
$pdf->MultiCell(13, 7, ($g10->pro_m != '' ? $g10->pro_m : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g10->pro_f != '' ? $g10->pro_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g10->pro_m+$g10->pro_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 5 / grade 11
$pdf->MultiCell(13, 7, ($g11->pro_m != '' ? $g11->pro_m : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g11->pro_f != '' ? $g11->pro_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g11->pro_m+$g11->pro_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 6 / grade 12
$pdf->MultiCell(13, 7, ($g12->pro_m != '' ? $g12->pro_m : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g12->pro_f != '' ? $g12->pro_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g12->pro_m+$g12->pro_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//total
$pdf->MultiCell(13, 7, $g7->pro_m+$g8->pro_m+$g9->pro_m+$g10->pro_m+$g11->pro_m+$g12->pro_m,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g7->pro_f+$g8->pro_f+$g9->pro_f+$g10->pro_f+$g11->pro_f+$g12->pro_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g7->pro_m+$g8->pro_m+$g9->pro_m+$g10->pro_m+$g11->pro_m+$g12->pro_m)+($g7->pro_f+$g8->pro_f+$g9->pro_f+$g10->pro_f+$g11->pro_f+$g12->pro_f),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->Ln();
//Promoted Ends
...
//grade 1 / grade 7
$pdf->MultiCell(13, 7,($g7->irr_m != '' ? $g7->irr_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g7->irr_f != '' ? $g7->irr_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g7->irr_m+$g7->irr_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 2 / grade 8
$pdf->MultiCell(13, 7,($g8->irr_m != '' ? $g8->irr_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g8->irr_f != '' ? $g8->irr_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g8->irr_m+$g8->irr_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 3 / grade 9
$pdf->MultiCell(13, 7,($g9->irr_m != '' ? $g9->irr_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g9->irr_f != '' ? $g9->irr_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g9->irr_m+$g9->irr_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 4 / grade 10
$pdf->MultiCell(13, 7,($g10->irr_m != '' ? $g10->irr_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g10->irr_f != '' ? $g10->irr_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g10->irr_m+$g10->irr_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 5 / grade 11
$pdf->MultiCell(13, 7,($g11->irr_m != '' ? $g11->irr_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g11->irr_f != '' ? $g11->irr_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g11->irr_m+$g11->irr_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 6 / grade 12
$pdf->MultiCell(13, 7,($g12->irr_m != '' ? $g12->irr_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g12->irr_f != '' ? $g12->irr_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g12->irr_m+$g12->irr_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//total
$pdf->MultiCell(13, 7, $g7->irr_m+$g8->irr_m+$g9->irr_m+$g10->irr_m+$g11->irr_m+$g12->irr_m,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g7->irr_f+$g8->irr_f+$g9->irr_f+$g10->irr_f+$g11->irr_f+$g12->irr_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g7->irr_m+$g8->irr_m+$g9->irr_m+$g10->irr_m+$g11->irr_m+$g12->irr_m)+($g7->irr_f+$g8->irr_f+$g9->irr_f+$g10->irr_f+$g11->irr_f+$g12->irr_f),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->Ln();
//IRREGULAR Ends
...
//grade 1 / grade 7
$pdf->MultiCell(13, 7,($g7->re_m != '' ? $g7->re_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g7->re_f != '' ? $g7->re_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g7->re_m+$g7->re_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 2 / grade 8
$pdf->MultiCell(13, 7,($g8->re_m != '' ? $g8->re_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g8->re_f != '' ? $g8->re_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g8->re_m+$g8->re_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 3 / grade 9
$pdf->MultiCell(13, 7,($g9->re_m != '' ? $g9->re_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g9->re_f != '' ? $g9->re_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g9->re_m+$g9->re_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 4 / grade 10
$pdf->MultiCell(13, 7,($g10->re_m != '' ? $g10->re_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g10->re_f != '' ? $g10->re_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
...
//grade 1 / grade 7
$pdf->MultiCell(13, 7,($g7->b_m != '' ? $g7->b_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g7->b_f != '' ? $g7->b_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g7->b_m+$g7->b_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 2 / grade 8
$pdf->MultiCell(13, 7,($g8->b_m != '' ? $g8->b_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g8->b_f != '' ? $g8->b_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g8->b_m+$g8->b_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 3 / grade 9
$pdf->MultiCell(13, 7,($g9->b_m != '' ? $g9->b_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g9->b_f != '' ? $g9->b_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g9->b_m+$g9->b_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 4 / grade 10
$pdf->MultiCell(13, 7,($g10->b_m != '' ? $g10->b_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g10->b_f != '' ? $g10->b_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g10->b_m+$g10->b_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 5 / grade 11
$pdf->MultiCell(13, 7,($g11->b_m != '' ? $g11->b_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g11->b_f != '' ? $g11->b_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g11->b_m+$g11->b_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 6 / grade 12
$pdf->MultiCell(13, 7,($g12->b_m != '' ? $g12->b_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g12->b_f != '' ? $g12->b_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g12->b_m+$g12->b_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//total
$pdf->MultiCell(13, 7, $g7->b_m+$g8->b_m+$g9->b_m+$g10->b_m+$g11->b_m+$g12->b_m,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g7->b_f+$g8->b_f+$g9->b_f+$g10->b_f+$g11->b_f+$g12->b_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g7->b_m+$g8->b_m+$g9->b_m+$g10->b_m+$g11->b_m+$g12->b_m)+($g7->b_f+$g8->b_f+$g9->b_f+$g10->b_f+$g11->b_f+$g12->b_f),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->Ln();
//BEGINNING Ends
...
//grade 1 / grade 7
$pdf->MultiCell(13, 7,($g7->d_m != '' ? $g7->d_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g7->d_f != '' ? $g7->d_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g7->d_m+$g7->d_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 2 / grade 8
$pdf->MultiCell(13, 7,($g8->d_m != '' ? $g8->d_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g8->d_f != '' ? $g8->d_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g8->d_m+$g8->d_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 3 / grade 9
$pdf->MultiCell(13, 7,($g9->d_m != '' ? $g9->d_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g9->d_f != '' ? $g9->d_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g9->d_m+$g9->d_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 4 / grade 10
$pdf->MultiCell(13, 7,($g10->d_m != '' ? $g10->d_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g10->d_f != '' ? $g10->d_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
...
//grade 1 / grade 7
$pdf->MultiCell(13, 7,($g7->ap_m != '' ? $g7->ap_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g7->ap_f != '' ? $g7->ap_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g7->ap_m+$g7->ap_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 2 / grade 8
$pdf->MultiCell(13, 7,($g8->ap_m != '' ? $g8->ap_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g8->ap_f != '' ? $g8->ap_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g8->ap_m+$g8->ap_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 3 / grade 9
$pdf->MultiCell(13, 7,($g9->ap_m != '' ? $g9->ap_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g9->ap_f != '' ? $g9->ap_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g9->ap_m+$g9->ap_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 4 / grade 10
$pdf->MultiCell(13, 7,($g10->ap_m != '' ? $g10->ap_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g10->ap_f != '' ? $g10->ap_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
...
//grade 1 / grade 7
$pdf->MultiCell(13, 7,($g7->p_m != '' ? $g7->p_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g7->p_f != '' ? $g7->p_m : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g7->p_m+$g7->p_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 2 / grade 8
$pdf->MultiCell(13, 7,($g8->p_m != '' ? $g8->p_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g8->p_f != '' ? $g8->p_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g8->p_m+$g8->p_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 3 / grade 9
$pdf->MultiCell(13, 7,($g9->p_m != '' ? $g9->p_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g9->p_f != '' ? $g9->p_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g9->p_m+$g9->p_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 4 / grade 10
$pdf->MultiCell(13, 7,($g10->p_m != '' ? $g10->p_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g10->p_f != '' ? $g10->p_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
...
//grade 1 / grade 7
$pdf->MultiCell(13, 7,($g7->a_m != '' ? $g7->a_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g7->a_f != '' ? $g7->a_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g7->a_m+$g7->a_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 2 / grade 8
$pdf->MultiCell(13, 7,($g8->a_m != '' ? $g8->a_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g8->a_f != '' ? $g8->a_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g8->a_m+$g8->a_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 3 / grade 9
$pdf->MultiCell(13, 7,($g9->a_m != '' ? $g9->a_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g9->a_f != '' ? $g9->a_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, $g9->a_m+$g9->a_f,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
//grade 4 / grade 10
$pdf->MultiCell(13, 7,($g10->a_m != '' ? $g10->a_m : '') ,1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->MultiCell(13, 7, ($g10->a_f != '' ? $g10->a_f : ''),1, 'C', 0, 0, '', '', true, 0, false, true, 7, 'M');
...
$pdf->MultiCell(50, 8, $principal != null ? strtoupper($principal->firstname.' '.$principal->lastname) : '','B', 'C', 0, 0, '', '', true, 0, false, true, 8, 'M');

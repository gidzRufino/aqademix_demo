...
class MYPDF extends Pdf
{
    ...
    public function Header()
    {
        ...
        $this->SetXY(240, 45);
        $this->Cell(0, 4.3, "Report for the Month of : " . date("F", mktime(0, 0, 0, $CI->uri->segment(3), 10)), 0, 0, 'L');
    }
...
if ($CI->uri->segment(4) < abs(06) && date('Y') > $sy):
    $year = date('Y');
else:
    $year = $sy;
endif;
...
$previousMonth = abs($CI->uri->segment(4)) - 1;
if ($previousMonth < 10):
...
foreach ($section->result() as $sec) {
    ...
    $dailyAttendance = Modules::run('attendance/getMonthlyAttendanceSummary', $CI->uri->segment(3), $sec->section_id, $this->session->userdata('attend_auto'), $year);
    ...
    //Drop out
    $maleDrpPm = Modules::run('registrar/getStudentStatus', 3, 'Male', $sec->section_id, $CI->uri->segment(3), $school_year, 0);
    $femaleDrpPm = Modules::run('registrar/getStudentStatus', 3, 'Female', $sec->section_id, $CI->uri->segment(3), $school_year, 0);
    ...
    $maleDrpthis = Modules::run('registrar/getStudentStatus', 3, 'Male', $sec->section_id, $CI->uri->segment(3), $school_year, 1);
    $femaleDrpthis = Modules::run('registrar/getStudentStatus', 3, 'Female', $sec->section_id, $CI->uri->segment(3), $school_year, 1);
    ...
    // transfered out
    $maleToPm = Modules::run('registrar/getStudentStatus', 1, 'Male', $sec->section_id, $CI->uri->segment(3), $school_year, 0);
    $femaleToPm = Modules::run('registrar/getStudentStatus', 1, 'Female', $sec->section_id, $CI->uri->segment(3), $school_year, 0);
    ...
    $maleToThis = Modules::run('registrar/getStudentStatus', 1, 'Male', $sec->section_id, $CI->uri->segment(3), $CI->uri->segment(4), 1);
    $femaleToThis = Modules::run('registrar/getStudentStatus', 1, 'Female', $sec->section_id, $CI->uri->segment(3), $CI->uri->segment(4), 1);
    ...
    //Transferred In
    $maleTiPm = Modules::run('registrar/getStudentStatus', 2, 'Male', $sec->section_id, $CI->uri->segment(3), $school_year, 0);
    $femaleTiPm = Modules::run('registrar/getStudentStatus', 2, 'Female', $sec->section_id, $CI->uri->segment(3), $school_year, 0);
    ...
    $maleTiThis = Modules::run('registrar/getStudentStatus', 2, 'Male', $sec->section_id, $CI->uri->segment(3), $school_year, 1);
    $femaleTiThis = Modules::run('registrar/getStudentStatus', 2, 'Female', $sec->section_id, $CI->uri->segment(3), $school_year, 1);
...
foreach ($gradeLevel as $level) {
    ...
    $dailyAttendanceSum = Modules::run('attendance/getMonthlyAttendanceSummaryPerLevel', $CI->uri->segment(3), $level->grade_id, $this->session->userdata('attend_auto'), $year);
...
ob_end_clean();
$pdf->Output('DepEdForm4_' . date("F", mktime(0, 0, 0, $CI->uri->segment(4), 10)) . '.pdf', 'I');

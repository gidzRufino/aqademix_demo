            ...
            <div style="width: 100%; overflow-y: scroll;" class="pull-left col-lg-12" id="schedDetails">
                ...
                <div class="col-lg-10 col-md-12 col-xs-12">
                    <div class="alert alert-info clearfix">
                        ...
                        <?php else: 
                            switch($this->session->department):
                                case 1:
                                    $entrancefee = "1,500.00";
                                break;
                                case 2:
                                    $entrancefee = "1,000.00";
                                break;
                                default:
                                    $entrancefee = "1,000.00";
                            endswitch;
                            ?>
                            <p class="text-center">Pay a minimum amount of &#8369; <?php echo $entrancefee; ?> to the following payment centers: </p> <br/>
                        <?php endif; ?>
                        ...
                        <table class="table table-striped" style="background: white;">
                            ...
                            <tr>
                                <td colspan="3" class="text-center">
                                    Name:  <br />
                                    Address: Capistrano-Akut Sts. CDO City<br />

...
<div class="col-lg-12 no-padding">
    ...
    <?php
    if ($student->status == 6):
        if ($this->session->position_id == 1 || $this->session->position_id == 49):
    ?>
    ...
    ?>
            <div class="col-lg-12 col-xs-12">
                <div class="col-lg-4 col-md-4 col-xs-12"></div>
                <div class="col-lg-4 col-md-4 col-xs-12">
                    <button id="onlineBtnApprove" class="btn btn-warning pull-right">Approve Enrollment Application ?</button>
                </div>
                <div class="col-lg-4 col-md-4 col-xs-12"></div>
            </div>
        <?php else:
        ?>
            <table class="table table-striped table-bordered table-responsive" id="">
                ...
                <?php
                if (
                    $this->session->userdata('position_id') == 1 ||
                            ...
                            <td colspan="5">
                                <button class="pull-left btn btn-small btn-primary"
                                    ...
                                    data-content="
                                        ...
                                        </div>">Send Remarks</button>
                                <?php if ($student->status != 1): ?>
                                    <?php if (!$isOnline): ?>
                                        <button id="btnApprove" class="btn btn-warning pull-right">Approve ?</button>
                                    <?php else: ?>
                                        <button onclick="approveOnlineApp()" class="btn btn-warning pull-right">Approve Enrollment Application ?</button>
                ...
                <div class="panel-body">
                    ...
                    ?>
                        <div class="col-lg-4">
                            ...
                            <h6><?php echo $file ?></h6>
                            <!--<img class="img-responsive myImg" style="width: 200px;" src="<?php // echo base_url($directory . '/' . $file)                                
                                                                                                ?>" alt="<?php // echo $file                                
                                                                                                            ?>">-->
                        </div>
                    <?php
                    ...
                    <div class="panel-body">
                        <table class="table table-striped table-responsive">
                            ...
                            if ($paymentReceipt->row() || $payment > 0):
                                ...
                                <?php
                                if (
                                    $this->session->userdata('position_id') == 1 || $this->session->position == "Cashier" ||
                                    $this->session->position == 'School Administrator' ||
                                    $this->session->position == "Accounting Staff" ||
                                    $this->session->position == 'Accountant'
                                ):
    ...
    $(document)[_0x3822('0x3')](function() {
        ...
        deleteEnrollmentFile = function(_0x4f7737) {
            ...
            if (_0x5b3ea8 == !![]) {
                ...
                $[_0x3822('0x2d')]({
                    ...
                    'data': {
                        'link': _0x4f7737,
                        'user_id': $('#user_id')[_0x3822('0x35')](),
                        'csrf_test_name': $[_0x3822('0x36')]('csrf_cookie_name')
                    },
                    'success': function(_0x2f7383) {
                        alert(_0x2f7383);
                        location['reload']();
                    }
                });
        ...
        $(_0x3822('0x38'))[_0x3822('0x18')](function() {
            ...
            if (_0x57cc75 == !![]) {
                ...
                $[_0x3822('0x2d')]({
                    ...
                    'dataType': 'json',
                    'data': {
                        'st_id': $('#st_id')[_0x3822('0x35')](),
                        'user_id': $('#user_id')['val'](),
                        'semester': $(_0x3822('0x1f'))['val'](),
                        'school_year': $(_0x3822('0x20'))['val'](),
                        'csrf_test_name': $[_0x3822('0x36')](_0x3822('0x15'))
                    },
                    'beforeSend': function() {
        ...
        $(_0x3822('0x5'))[_0x3822('0x18')](function() {
            ...
            $[_0x3822('0x2d')]({
                ...
                'url': _0x4a9c9e,
                'dataType': 'json',
                'data': _0x3822('0x28') + $[_0x3822('0x36')]('csrf_cookie_name'),
                'success': function(_0x2b2e9b) {
        ...
        $(_0x3822('0x1a'))[_0x3822('0x18')](function() {
            ...
            if (_0x1becd0 == !![]) {
                ...
                $['ajax']({
                    'type': _0x3822('0x34'),
                    'url': _0x361c0d,
                    'dataType': _0x3822('0xb'),
                    'data': _0x3822('0x28') + $[_0x3822('0x36')](_0x3822('0x15')),
                    'beforeSend': function() {
        ...
        sendAdmissionRemark = function() {
            ...
            $['ajax']({
                ...
                'data': {
                    ...
                    'st_id': _0x39e7ec,
                    'semester': _0x26b86a,
                    'school_year': _0x4bc94a,
                    'remarks': _0x1a708c
                },
                'success': function(_0x52fa83) {
                    alert(_0x52fa83);
                    location[_0x3822('0x31')]();
                }
            });
        ...
        sendSMS = function() {
            ...
            $[_0x3822('0x2d')]({
                'type': _0x3822('0x14'),
                'url': _0x177768,
                'data': _0x3822('0x26') + _0x22aaab + '&csrf_test_name=' + $[_0x3822('0x36')](_0x3822('0x15')),
                'beforeSend': function() {
        ...
        sendRemarks = function() {
            ...
            $[_0x3822('0x2d')]({
                ...
                'data': {
                    ...
                    'st_id': _0x5ac03f,
                    'semester': _0x3e5a8b,
                    'school_year': _0x12620b,
                    'remarks': _0xcd45af,
                    'adm_id': _0x55b42e
                },
                'success': function(_0x37ef71) {
                    alert(_0x37ef71);
                    location[_0x3822('0x31')]();
                }
            });
        ...
        removeSubject = function(_0x43edc1) {
            ...
            $['ajax']({
                ...
                'data': {
                    'csrf_test_name': $[_0x3822('0x36')](_0x3822('0x15')),
                    'user_id': _0x119664,
                    'subject_id': _0x43edc1,
                    'school_year': $(_0x3822('0x20'))[_0x3822('0x35')]()
                },
                'success': function(_0x211623) {
                    if (_0x211623['status'] == !![]) {

...
<dl class="dl-horizontal">
    ...
    <dd>
        ...
        <span title="double click to edit" id="a_major" >
            <?php if ($basicInfo->course != "" || $basicInfo->course != "N/A"):echo $major ? $major->maj_min : '';
else: echo "[empty]"; endif; ?> 
...
<dl class="dl-horizontal">
    ...
    <dd>
        ...
        <span title="double click to edit" id="a_minor" >
            <?php if($basicInfo->course!="" || $basicInfo->course!="N/A"):echo $minor ? $minor->maj_min : ''; else: echo "[empty]"; endif; ?> 

<div class='row clearfix'>
   ...
   <div class='form-group col-lg-3' id='Pos'>
            <label id='labelPosition' class='control-label' for='inputSection'>Position(s)</label>
            <div class='controls' id='AddedPosition'>
              <select name='inputPosition[]' style='width:230px;' id='inputPosition' multiple='multiple' required>
                  <option></option>

        ...
        <div class="modal-content">
            ...
            <form id="quickPostForm" method="post">
                <div class="modal-body">
                    <textarea id="postDetails" name="op_post" class="form-control summernote"></textarea>
                </div>
...
<script>
    ...
    $(function() {
        ...
        $('#quickPostForm').on('submit', function(e) {
            ...
            var url = '<?= base_url() . 'opl/submitQuickPost' ?>';
            var post = $('#postDetails').val();
            var target = $("#postTarget").val();
            var targetid = $('#postTargetID').val();

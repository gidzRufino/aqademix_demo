            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        ?>
                        <small class="muted"> A rubric is typically an evaluation tool or set of guidelines used to promote the consistent application of learning expectations, learning objectives, or learning standards in the classroom, or to measure their attainment against a consistent set of criteria.</small>
                    </h3>
                        ...
                        <div class="form-group col-lg-12 float-left" id="rubricCriteriaWrapper" style="display: none;">
                            <table class="table table-stripped table-hover">
                                <tr>
                                    <th>Criteria</th>
                                    <th>Percentage</th>
                                    <th id="thScale" colspan="">SCALE</th>
                                </tr>

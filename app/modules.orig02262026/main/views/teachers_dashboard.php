        ...
        <div class="col-lg-12">
            <div class="dashboard-header">
                <div>
                    ...
                    <p class="dashboard-subtitle">Your classes, attendance, and updates at a glance.</p>
                </div>
                <div class="dashboard-meta hidden-xs">
                    ...
                    <?php if (!empty(Modules::run('college/subjectmanagement/getAssignedSubjectRaw', $this->session->userdata('employee_id')))): ?>
                        <span style="margin-top:6px;">
                            <button class="btn btn-xs btn-default" onclick="document.location='<?php echo base_url('college'); ?>'">
                                <i class="fa fa-university"></i> Go to College
                            </button>
                        </span>
                    <?php endif; ?>
                </div>

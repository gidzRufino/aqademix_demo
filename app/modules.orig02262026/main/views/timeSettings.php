...
<div class="col-lg-12">
    ...
    <div class="col-lg-6">
        <div class="row">
                        ...
                        <table class='editableTable table table-bordered table-hover pull-right'>
                            ...
                            <?php foreach ($employeeTimeSettings as $setTime): ?>
                                <tr style="text-align: center">
                                    ...
                                    <td id="<?php echo $setTime->ps_id ?>_ami">
                                        <?php echo $setTime->ps_from ?>
                                    </td>
                                    <td id="<?php echo $setTime->ps_id ?>_amo">
                                        <?php echo $setTime->ps_to ?>
                                    </td>
                                    <td id="<?php echo $setTime->ps_id ?>_pmi">
                                        <?php echo $setTime->ps_from_pm ?>
                                    </td>
                                    <td id="<?php echo $setTime->ps_id ?>_pmo">
            ...
            <div class="col-lg-12">
                <?php echo $this->load->view('schoolDaysSettings'); ?>
            </div>
        </div>
    </div>
    <div class="col-lg-6">
                        ...
                        <table class='editableTable table table-bordered table-hover pull-right'>
                            ...
                            <?php foreach ($timeSet as $setTime): ?>
                                <tr style="text-align: center">
                                    ...
                                    <td id="<?php echo $setTime->section_id ?>_ami">
                                        <?php echo $setTime->time_in ?>
                                    </td>
                                    <td id="<?php echo $setTime->section_id ?>_amo">
                                        <?php echo $setTime->time_out ?>
                                    </td>
                                    <td id="<?php echo $setTime->section_id ?>_pmi">
                                        <?php echo $setTime->time_in_pm ?>
                                    </td>
                                    <td id="<?php echo $setTime->section_id ?>_pmo">

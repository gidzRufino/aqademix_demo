<div class="row">
    <div class="col-md-2">
        ...
        <div id="imgCrop" data-id="photo">
            <img class="img-circle img-responsive" style="width:150px; border:5px solid #fff" src="
            <?php
            if ($students->avatar != ""):
                echo base_url() . 'uploads/' . $students->avatar;
            else:
                echo base_url() . 'images/avatar/' . ($students->sex == 'Female' ? 'female.png' : 'male.png');
            endif;
            ?>" />
        </div>
    </div>

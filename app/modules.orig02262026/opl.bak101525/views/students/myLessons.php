                ...
                foreach ($discussionDetails as $discussion): ?>
                    <div class="card col-md-4 col-sm-4 float-left">
                        <div class="card-body">
                            ...
                            <a href="#" onclick="document.location='<?php echo base_url('opl/student/discussionDetails/' . $discussion->dis_sys_code . '/' . $school_year . '/' . $gradeLevel . '/' . $subject_id) ?>'"><?php echo ucwords(strtolower($discussion->dis_title)) ?></a>
                        </div>
                    </div>
                <?php endforeach;
                ?>

    ...
    <table class="table table-light table-striped">
        ...
        foreach ($students as $student):
            ...
            if ($student->avatar != '' || $student->avatar != NULL):
                if (file_exists('uploads/' . $student->avatar)):
                    $avatar = site_url('uploads/' . $student->avatar);
                else:
                    $avatar = site_url('images/avatar/' . ($student->sex == 'Female' ? 'female.png' : 'male.png'));
                endif;
            else:
                $avatar = site_url('images/avatar/' . ($student->sex == 'Female' ? 'female.png' : 'male.png'));
            endif;
        ?>
            <tr>
                ...
                <td>
                    <img class="img-circle" width="30" src="<?php echo $avatar; ?>" alt="User Image">

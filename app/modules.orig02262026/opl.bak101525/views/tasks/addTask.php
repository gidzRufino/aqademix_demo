            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-header">
                    ...
                    <div class="form-group col-xs-12 col-lg-5 float-right" id="month" style="">
                        ...
                        <div id="addTerm" class="float-right">
                            <select style="font-size:16px;" tabindex="-1" id="inputTerm" class="hasValue">
                                <?php
                                $first = "";
                                $second = "";
                                $third = "";
                ...
                <div class="card-body">
                    <div class="form-group col-xs-12 col-lg-6 float-left">
                        ...
                        <input onclick="if($('#inputTerm').val()==0){alert('Please Select Grading Period!'); $('#inputTerm').focus()};" type="text" class="form-control hasValue" id="taskTitle" placeholder="Task Title" required>
                    </div>
                    ...
                    <div class="form-group col-xs-12 col-lg-6 pull-left">
                        ...
                        <select id="gradeLevel" class="form-control hasValue" onclick="fetchLesson(this.value)" required>
                            <option value="">Select Subject, Grade Level and Section</option>
                    ...
                    <div class="form-group col-xs-12 col-lg-6 pull-left" required>
                    ...
                    <br />
                    <div id="gradingWrapper" class="form-group col-xs-12 col-lg-3 float-left">
                        <label>GS Component</label>
                        <select id="gsComponent" class="form-control hasValue" required>
                            <option value="">Select a GS Component</option>
                        </select>
                    </div>

                    <div class="form-group col-xs-12 col-lg-3 float-left">
                        <label for="exampleInputEmail1">Number of Items</label>
                        <input type="text" class="form-control hasValue" id="numItems" placeholder="Total Possible Score">
                    </div>
                    ...
                    <div class="form-group " id="onlineEditor">
                        ...
                        <textarea class="textarea hasValue" id="taskDetails" placeholder="Place some text here"
                    ...
                    <div class="form-group col-lg-6 col-xs-12 float-left">
                        ...
                        <input type="date" class="form-control hasValue" id="startDate" placeholder="">
                    </div>
                    <div class="form-group col-lg-6 col-xs-12 float-left">
                        <label for="exampleInputEmail1">Start Time</label>

                        <input type="time" value="00:00 pm" class="form-control timePick hasValue" id="timeStart" placeholder="">
                    </div>
                    <div class="form-group col-lg-6 col-xs-12 float-left">
                        <label for="exampleInputEmail1">Date Deadline</label>
                        <input type="date" class="form-control hasValue" id="deadlineDate" placeholder="">
                    </div>
                    <div class="form-group col-lg-6 col-xs-12 float-left">
                        <label for="exampleInputEmail1">Time Deadline</label>

                        <input type="time" value="00:00 pm" class="form-control timePick hasValue" id="timeDeadline" placeholder="">
                    </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#gradeLevel').on('change', function(e) {

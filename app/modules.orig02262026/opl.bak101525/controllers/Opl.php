...
class Opl extends MX_Controller
{
    ...
    {
        $data['post'] = $this->getPost(($this->session->isOplAdmin) ? NULL : $this->session->username);
        echo $this->load->view('dashboardPost', $data);
    }
        ...
        if ($file == NULL) :
            ...
            switch ($type):
                case 'task':
                    ...
                    $config['upload_path'] = UPLOADPATH . $this->session->school_year . DIRECTORY_SEPARATOR . 'faculty' . DIRECTORY_SEPARATOR . $this->session->username . DIRECTORY_SEPARATOR . $grade . DIRECTORY_SEPARATOR . 'task';
                    break;
                case 'unit':
                    $config['upload_path'] = UPLOADPATH . $this->session->school_year . DIRECTORY_SEPARATOR . 'faculty' . DIRECTORY_SEPARATOR . $this->session->username . DIRECTORY_SEPARATOR . $this->post('subject_id') . DIRECTORY_SEPARATOR . 'unit';
                    break;
                case 'discussion':
                    $grade = explode("-", $this->post('grade'))[0];
                    $config['upload_path'] = UPLOADPATH . $school_year . DIRECTORY_SEPARATOR . 'faculty' . DIRECTORY_SEPARATOR . $this->session->username . DIRECTORY_SEPARATOR . $grade . DIRECTORY_SEPARATOR . 'discussion';
                    break;
            endswitch;

            ...
            <div class="modal-body">
                ...
                <div id="Parents">
                    <div class="col-lg-12 col-xs-12">
                        ...
                        <div class="form-group col-lg-3 col-xs-12">
                            <label>Date of Birth<span class="error">*</span></label>
                            <input style="margin-right: 10px;" class="form-control" name="f_inputBdate" type="date"  data-date-format="yyyy-mm-dd" id="f_inputBdate" placeholder="Date of Birth" required>
                            <div class="text-danger" id="inputBdateEmpty"></div>
                        </div>
                        <div class="form-group col-lg-3 col-md-12">
                    ...
                    <div class="col-lg-12 col-xs-12" style="border-top: 1px solid gray; padding-top:10px;">
                        ...
                        <div class="form-group col-lg-3 col-xs-12">
                            <label>Date of Birth<span class="error">*</span></label>
                            <input style="margin-right: 10px;" class="form-control" name="m_inputBdate" type="date"  data-date-format="yyyy-mm-dd" id="m_inputBdate" placeholder="Date of Birth" required>
                            <div class="text-danger" id="inputBdateEmpty"></div>
                        </div>
                        <div class="form-group col-lg-3 col-xs-12">

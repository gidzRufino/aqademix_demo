    ...
    <div class="panel panel-green">
        ...
        <div class="panel-body clearfix">
            <div class="control-group">
                    <div class="controls">
                        <select onclick="selectSectionAssign(this.value), getSubjects(this.value)" style="width:100%; margin-bottom: 5px;"  tabindex="-1" id="inputGradeAssign"  class="populate select2-offscreen span2">
            ...
            <div id='tle_specs' class='control-group' style='display: none;'>
                <div class='controls'>
                  <select name='inputSpecialization' style='width:100%; margin-bottom:5px;' id='inputSpecialization' class='populate select2-offscreen span2' required>

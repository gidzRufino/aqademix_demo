...
$pdf->MultiCell(50, 5, '', 'B', 'C', 0, 0, '', '', true, 0, false, true, 5, 'B');
...
for ($i = $gs_start; $i <= (12 + $gs_end); $i++):
    ...
    $pdf->SetX(15);
    $pdf->MultiCell(12, 7, $monthName, 1, 'L', 0, 0, '', '', true, 0, false, true, 7, 'M');
    $pdf->Ln();
endfor;
...
$pdf->MultiCell(55, 5, urldecode($this->uri->segment(8)), 'B', 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->Ln(10);
...
$pdf->MultiCell(75, 5, '', 0, 'R', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->MultiCell(45, 5, '', 'B', 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->Ln();
...
$pdf->MultiCell(128, 15, 'Aqademix Demo', 0, 'C', 0, 0, '', '', true, 0, false, true, 15, 'M');
$pdf->Ln(12);
...
$pdf->MultiCell(128, 10, '', 0, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->Ln(5);
...
$pdf->MultiCell(128, 15, 'School Year ' . $sy . ' - ' . ($sy + 1), 0, 'C', 0, 0, '', '', true, 0, false, true, 15, 'M');
$pdf->Ln(10);

$pdf->SetX(158);
$pdf->SetFont('bernard_mt', 'R', 10);
$pdf->MultiCell(128, 15, 'School ID : ' . $settings->school_id, 0, 'C', 0, 0, '', '', true, 0, false, true, 15, 'M');
$pdf->Ln(15);
...
$pdf->SetX(158);
$pdf->SetFont('times', 'R', 9);
$pdf->MultiCell(10, 7, 'Name', 0, 'L', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->SetFont('times', 'B', 15);
$pdf->MultiCell(115, 7, '          ' . ucwords(strtolower($student->firstname . ' ' . ($student->middlename != '' ? substr($student->middlename, 0, 1) . '.' : '' ) . ' ' . $student->lastname)), 'B', 'L', 0, 0, '', '', true, 0, false, true, 7, 'M');
$pdf->Ln(10);

            ...
            <table class="table table-striped table-bordered text-center tablesorter">
                ...
                <tr>
                    ...
                    foreach($category as $cat => $k) {
                        ...
                        echo '<th colspan="' . $teachersAssessment->num_rows() . '" style="text-align: center; white-space: nowrap; width: auto">' . $k->component . ' ' . substr($k->category_name, 0, 1).' ('.($k->weight*100).'% )' . '<button class="btn btn-sm btn-primary round pull-right"><i class="fa fa-plus"></i></button</th>';
                    }
                    ?>
                    <th>Grade</th>
                </tr>
                ...
                <tr>
                    <th>Students Name</th>
                    <th colspan="<?php echo ($total_assess == 0 ? 3 : $total_assess) ?>"></th>
                    <th></th>
                    </tr>
                    <?php
                    ...
                    foreach ($students->result() as $s) {
                        ...
                        <tr>
                            ...
                            if ($total_assess == 0) {
                                ...
                                ?>
                                <td class="td_totn text-center" style="font-weight:bold; width:50px;" id="tg-<?php echo $s->st_id ?>"><?php  echo $totalGrade; ?></td>
                            <?php } ?>
                            <!-- <td class="td_totn text-center" style="font-weight:bold; width:50px;" id="tg-<?php // echo $s->st_id ?>"><?php // echo ($kk == 0 ? (($isGradeValidated == 1 ? round($totalGrade->$grading,2) : '')) : ''); ?></td> -->
                        </tr>
                    <?php 
                    $kk = 0;
                    }
